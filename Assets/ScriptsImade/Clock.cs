...
public class Clock : MonoBehaviour {
	...
	void skyChange()
	{
		...
		//switch between background music
		if(hours >= 5 && hours < 18 && daysongplaying == false){
			daysongplaying = true;
			playdaysong();
		}
		if(hours >= 18 && hours < 5 && nightsongplaying == false){
			playnightsong();
